export const hardQuestionsData = [
  {
    ...
    directAnswer:
      "O Alcorão não menciona a idade de Aisha — em nenhum versículo, em nenhum capítulo. Essa questão vem exclusivamente dos hadiths, que são registros humanos compilados mais de 200 anos após os eventos. O próprio Alcorão estabelece a maturidade como critério para casamento (4:6), não uma idade específica. Dentro da tradição islâmica, existe debate acadêmico sério sobre a idade real, com estimativas que variam de 9 a 19 anos dependendo da metodologia de cálculo.",
    context:
      "Para entender essa questão, é preciso entender o que são hadiths. Diferente do Alcorão — que muçulmanos consideram a palavra literal de Deus, preservada intacta —, os hadiths são relatos orais transmitidos de pessoa para pessoa durante gerações e compilados em livros cerca de 200-300 anos depois. Mesmo os hadiths classificados como 'autênticos' (sahih) passam por cadeias de transmissão humana, sujeitas a falhas de memória, contexto e interpretação. A tradição islâmica reconhece isso e desenvolveu uma ciência inteira (ilm al-hadith) para avaliar a confiabilidade de cada relato. Isso não significa que todos os hadiths são falsos — mas significa que eles não têm o mesmo peso que o Alcorão. Quando o Alcorão e um hadith divergem, o Alcorão prevalece. E o Alcorão fala em maturidade, não em idade.",
    islamicScholarship:
      "O debate entre estudiosos islâmicos é mais amplo do que a maioria imagina. Uma corrente significativa de pesquisadores — incluindo o xeique Javed Ahmad Ghamidi (Paquistão), a dra. Kecia Ali (EUA) e historiadores como o dr. Muhammad ibn Adam al-Kawthari — questiona a idade relatada nos hadiths. Suas evidências incluem: cronologia de eventos (se Aisha presenciou certos acontecimentos, as contas de 6 anos não fecham), a idade de sua irmã Asma bint Abu Bakr (que tem registro mais sólido), e inconsistências nos relatos do mesmo narrador (Hisham ibn Urwa, que era idoso quando transmitiu o relato no Iraque). Essas análises chegam a idades entre 14 e 19 anos. Estudiosos clássicos aceitaram a narrativa tradicional sem questionamento porque era culturalmente normal no contexto da época — casamentos precoces eram padrão em toda civilização antiga, incluindo Roma, Europa cristã medieval e Arábia pré-islâmica. A maioria dos países muçulmanos hoje estabelece idade mínima de casamento entre 16-18 anos.",
    honestConclusion:
      "O que sabemos com certeza: o Alcorão não menciona a idade de Aisha. O critério corânico para casamento é maturidade e capacidade de juízo, não uma idade fixa. Os relatos sobre a idade vêm de fontes humanas compiladas séculos depois, e existe debate acadêmico legítimo sobre os números. O que cada pessoa precisa decidir é: uma tradição religiosa é definida por relatos humanos debatíveis, ou pelos princípios da sua escritura sagrada? O Kalam sempre prioriza o Alcorão como fonte primária — e o Alcorão é claro: maturidade e consentimento.",
    difficulty: "high",
    sources: [
      {
        type: "quran",
        reference: "Alcorão 4:6",
        text: "E provai os órfãos até que alcancem a idade de casamento; então, se perceberdes neles maturidade de juízo, entregai-lhes seus bens.",
        context: "O Alcorão estabelece maturidade de juízo (rushd) como critério para casamento — não uma idade numérica. Este é o princípio corânico que governa o tema."
      },
      {
        type: "scholarly",
        reference: "Dr. Kecia Ali, 'Sexual Ethics and Islam'",
        text: "A idade de Aisha é baseada em uma única cadeia de transmissão através de Hisham ibn Urwa, que relatou em idade avançada no Iraque.",
        context: "Estudiosos questionam a cadeia de transmissão, com evidências cronológicas apontando para idade entre 14 e 19 anos."
      }
    ],
    quranPosition: "O Alcorão NÃO menciona a idade de Aisha em nenhum versículo. O princípio corânico para casamento é claro: maturidade de juízo e capacidade (4:6 — 'até que alcancem a idade de casamento'). O Alcorão também enfatiza consentimento mútuo (4:19) e tratamento digno entre cônjuges (30:21). Qualquer discussão sobre idades específicas vem exclusivamente de hadiths — registros humanos, não revelação divina.",
    internalDebate: "O debate é real e reconhecido dentro do Islam. A cadeia de transmissão do relato principal (via Hisham ibn Urwa) é questionada por pesquisadores que apontam: (1) Hisham relatou isso quando era idoso no Iraque, e seus relatos iraquianos são considerados menos confiáveis; (2) cronologias baseadas na idade de Asma bint Abu Bakr (irmã de Aisha) sugerem idades maiores; (3) referências a Aisha participando da Batalha de Uhud contradizem a idade de 9 anos, já que menores de 15 eram recusados no exército. A tradição clássica aceitou sem questionamento; a pesquisa moderna questiona com evidência. Ambas as posições existem dentro do Islam — e a maioria dos muçulmanos hoje repudia qualquer forma de casamento infantil."
  },
    ...
    sources: [
      {
        ...
        text: "Os homens são responsáveis pelas mulheres pelo que Allah deu a uns sobre outros e pelo que gastam de seus bens. As mulheres virtuosas são devotas e guardam na ausência o que Allah ordena guardar. Aquelas de quem temeis a rebeldia, admoestai-as, afastai-vos delas no leito, e [wa-idribuhunna]. Se vos obedecerem, não busqueis meios contra elas.",
        arabic: "ٱلرِّجَالُ قَوَّٰمُونَ عَلَى ٱلنِّسَآءِ بِمَا فَضَّلَ ٱللَّهُ بَعْضَهُمْ عَلَىٰ بَعْضٍ وَبِمَآ أَنفَقُوا۟ مِنْ أَمْوَٰلِهِمْ",
        context: "O verbo 'daraba' em árabe tem mais de 40 significados. A tradução 'bater' é a clássica, mas 'separar-se' ou 'afastar-se' também são linguisticamente válidas."
      },
      {
        type: "hadith",
        reference: "Sahih Muslim 1218 — Sermão de despedida",
        text: "Temei a Allah em relação às mulheres. Não batam nas servas de Allah.",
        context: "O Profeta Muhammad declarou isso em seu último sermão público, contradizendo a leitura literal violenta do versículo."
      }
    ],
    quranPosition: "O Quran em 4:34 usa o verbo 'daraba' que tem múltiplas traduções possíveis. O mesmo verbo aparece em 43:5 significando 'afastar/ignorar'. A sequência do versículo é progressiva: primeiro aconselhar, depois separar leitos, e o terceiro passo é disputado. O Quran em NENHUM outro versículo endossa violência contra a esposa — pelo contrário, 30:21 descreve o casamento como fonte de 'amor e misericórdia' (mawaddah wa rahmah).",
    internalDebate: "O debate linguístico é central: Laleh Bakhtiar traduziu 'daraba' como 'ir embora/separar-se' em sua tradução feminista do Quran (2007). O Prof. Khaled Abou El Fadl argumenta que a ética total do Quran torna qualquer violência doméstica haram. Estudiosos conservadores como Ibn Kathir aceitam a tradução 'bater' mas restringem severamente: sem deixar marca, sem atingir o rosto, com um miswak (graveto). Na prática, muitos juristas clássicos já consideravam a aplicação makruh (desaconselhável). A Tunísia e o Marrocos proibiram violência doméstica citando princípios islâmicos."
  },

  {
    ...
    sources: [
      {
        type: "quran",
        reference: "Surah Al-Baqara 2:282",
        text: "E tomai o testemunho de duas testemunhas dentre vossos homens. Se não houver dois homens, então um homem e duas mulheres, dentre aqueles que aceitais como testemunhas — para que se uma errar, a outra a lembre.",
        arabic: "وَٱسْتَشْهِدُوا۟ شَهِيدَيْنِ مِن رِّجَالِكُمْ فَإِن لَّمْ يَكُونَا رَجُلَيْنِ فَرَجُلٌ وَٱمْرَأَتَانِ",
        context: "Este versículo trata ESPECIFICAMENTE de contratos financeiros de dívida — o contexto mais restrito possível. Não é uma regra geral sobre testemunho."
      },
      {
        type: "quran",
        reference: "Surah An-Nur 24:6-9",
        text: "E aqueles que acusam suas esposas e não têm testemunhas senão eles mesmos — o testemunho de cada um deles é quatro juramentos... E afasta-se dela o castigo se ela jurar quatro juramentos por Allah que ele mente.",
        arabic: "وَيَدْرَؤُا۟ عَنْهَا ٱلْعَذَابَ أَن تَشْهَدَ أَرْبَعَ شَهَـٰدَٰتٍۭ بِٱللَّهِ",
        context: "Aqui o testemunho de UMA mulher anula o de UM homem — contradizendo a ideia de que a mulher vale sempre metade."
      }
    ],
    quranPosition: "O Quran trata o testemunho feminino de forma CONTEXTUAL, não universal. Em 2:282, a regra é para contratos financeiros — onde mulheres do século VII tinham menos experiência prática. Em 24:6-9, o testemunho de UMA mulher contra acusação de adultério tem peso IGUAL ao do marido. O Quran não declara inferioridade cognitiva feminina em nenhum versículo.",
    internalDebate: "Ibn Rushd (Averrois, séc. XII) já questionava a generalização dessa regra. Fatima Mernissi e Amina Wadud argumentam que era contextual — sobre experiência em transações, não capacidade. Tariq Ramadan defende revisão. Na prática, a maioria dos países muçulmanos modernos trata o testemunho feminino como igual em tribunais civis. O Irã e a Arábia Saudita mantêm distinções. O debate revela que há base textual para AMBAS as posições."
  },

  {
    ...
    sources: [
      {
        type: "quran",
        reference: "Surah Al-Baqara 2:190",
        text: "Combatei pela causa de Allah aqueles que vos combatem, mas não sejais os agressores. Allah não ama os agressores.",
        arabic: "وَقَـٰتِلُوا۟ فِى سَبِيلِ ٱللَّهِ ٱلَّذِينَ يُقَـٰتِلُونَكُمْ وَلَا تَعْتَدُوٓا۟",
        context: "O versículo condiciona o combate à DEFESA ('aqueles que vos combatem') e proíbe explicitamente a agressão."
      },
      {
        type: "quran",
        reference: "Surah Al-Baqara 2:256",
        text: "Não há compulsão na religião. A orientação se distinguiu do erro.",
        arabic: "لَآ إِكْرَاهَ فِى ٱلدِّينِ قَد تَّبَيَّنَ ٱلرُّشْدُ مِنَ ٱلْغَىِّ",
        context: "Princípio fundamental que proíbe conversão forçada e, por extensão, guerra religiosa ofensiva."
      }
    ],
    quranPosition: "O Quran autoriza o combate DEFENSIVO (2:190 — 'combatei aqueles que vos combatem, mas não sejais agressores') e proíbe explicitamente a compulsão religiosa (2:256). Os versículos de combate (9:5, 9:29) foram revelados em contextos de tratados quebrados por tribos específicas. O jihad 'maior' (contra o ego) é o principal no Quran, não o jihad militar.",
    internalDebate: "O debate entre jihad defensivo vs. ofensivo é antigo. Juristas clássicos como Al-Shafi'i desenvolveram regras de guerra (siyar) sofisticadas. O jihadismo moderno de Qutb e Azzam é uma INOVAÇÃO ideológica que a maioria dos estudiosos rejeita. Al-Azhar, a mais antiga universidade islâmica, condena explicitamente o terrorismo. O conceito de 'guerra santa' é cristão (Cruzadas), não islâmico — foi projetado no Islam pelo Ocidente."
  },
    ...
    sources: [
      {
        ...
        text: "E por dizerem: Matamos o Messias, Jesus filho de Maria, Mensageiro de Allah — mas não o mataram nem o crucificaram, porém assim lhes pareceu. E Allah o elevou para Si.",
        arabic: "وَمَا قَتَلُوهُ وَمَا صَلَبُوهُ وَلَـٰكِن شُبِّهَ لَهُمْ",
        context: "O Quran nega a crucificação de Jesus de forma categórica. 'Shubbiha lahum' — 'assim lhes pareceu' — é a base de todas as teorias islâmicas sobre o que aconteceu."
      }
    ],
    quranPosition: "O Quran é categórico em 4:157-158: Jesus NÃO foi crucificado nem morto. 'Mas assim lhes pareceu' (shubbiha lahum). Allah o elevou para Si. Se não houve crucificação, a questão do túmulo vazio simplesmente não se aplica dentro do framework islâmico.",
    internalDebate: "As interpretações islâmicas sobre o 'como' variam: substitutistas dizem que outro foi crucificado no lugar de Jesus (posição majoritária clássica); outros dizem que foi ilusão divina; outros que Jesus sobreviveu. O que NÃO é debatido no Islam é que Jesus está vivo e retornará — isso é consenso. O debate é sobre o mecanismo da salvação, não sobre o fato."
  },
    ...
    sources: [
      {
        ...
        text: "Lê! Em nome do teu Senhor que criou.",
        arabic: "ٱقْرَأْ بِٱسْمِ رَبِّكَ ٱلَّذِى خَلَقَ",
        context: "A primeira palavra revelada ao Profeta foi 'Iqra' (Lê/Recita) — o Islam nasce como religião da LEITURA e do conhecimento."
      },
      {
        type: "scholarly",
        reference: "Consenso jurídico (ijma')",
        text: "A salah ritual requer árabe; o du'a pessoal pode ser em qualquer língua.",
        context: "A distinção entre salah (rito formal) e du'a (súplica pessoal) resolve a aparente rigidez: a comunicação íntima com Deus não tem barreira linguística."
      }
    ],
    quranPosition: "O Quran foi revelado em árabe (12:2, 43:3) e considera-se que a tradução não captura a totalidade do texto original. A salah em árabe é um rito litúrgico compartilhado — como o latim na missa católica foi por séculos. O du'a (súplica pessoal) pode ser feito em QUALQUER idioma, a qualquer momento.",
    internalDebate: "O Imam Abu Hanifa inicialmente permitiu orar em persa, mas depois reverteu a posição. Estudiosos como Tariq Ramadan discutem se a obrigatoriedade do árabe na salah é princípio fixo ou norma adaptável. Na prática, a maioria dos muçulmanos não-árabes aprende o significado das frases da oração — são poucos versículos curtos. O debate real é menos sobre 'pode ou não' e mais sobre investir em ENTENDER o que se diz."
  },
    ...
    sources: [
      {
        ...
        text: "Criamos o ser humano de uma quintessência de barro. Depois o fizemos uma gota num lugar seguro. Depois criamos da gota um coágulo, e do coágulo um embrião, e do embrião ossos, e revestimos os ossos de carne, e depois o fizemos outra criação.",
        arabic: "وَلَقَدْ خَلَقْنَا ٱلْإِنسَـٰنَ مِن سُلَـٰلَةٍ مِّن طِينٍ",
        context: "Descrição do desenvolvimento embrionário no Quran — considerada notável por sua precisão para o século VII. Não contradiz necessariamente a evolução, pois descreve processo criativo, não mecanismo biológico."
      }
    ],
    quranPosition: "O Quran descreve a criação como ato divino intencional, não como processo mecânico. Não há contradição EXPLÍCITA com a evolução no texto — o Quran diz O QUÊ e POR QUÊ (Deus criou com propósito), não o COMO (por qual mecanismo). Versículos como 71:14 ('Ele vos criou em estágios') podem até ser lidos como compatíveis com desenvolvimento gradual.",
    internalDebate: "Hamza Yusuf aceita evolução como possibilidade. Nidhal Guessoum (astrofísico argelino) escreveu livro inteiro sobre compatibilidade Islam-ciência. Yasir Qadhi (conservador popular) rejeita evolução humana especificamente mas aceita evolução animal. O Conselho de Ulemas da Arábia Saudita rejeita completamente. A tradição islâmica medieval (Al-Biruni, Ibn Khaldun) já discutia conceitos proto-evolucionários — a tensão é moderna, não originária."
  },

  {
    ...
    sources: [
      {
        type: "quran",
        reference: "Surah Al-A'raf 7:80-81",
        text: "E [mencionai] Lut, quando disse ao seu povo: Praticais a indecência que ninguém no mundo praticou antes de vós? Vós vos chegais aos homens com desejo em vez das mulheres. Sois um povo que transgride.",
        arabic: "أَتَأْتُونَ ٱلرِّجَالَ شَهْوَةً مِّن دُونِ ٱلنِّسَآءِ بَلْ أَنتُمْ قَوْمٌ مُّسْرِفُونَ",
        context: "A história de Lut é a base principal da proibição. O debate é se condena a homossexualidade em si ou a violência sexual/coerção que o povo de Lut praticava."
      }
    ],
    quranPosition: "O Quran referencia a história de Lut (7:80-84, 26:165-175, 29:28-29) como condenação de 'fawahisha' (atos abomináveis). A tradição clássica interpreta isso como proibição da homossexualidade. Leituras revisionistas argumentam que o crime central era violação de hóspedes e coerção sexual, não orientação consensual — mas essa é uma posição minoritária.",
    internalDebate: "Posição majoritária (Al-Azhar, Yusuf Al-Qaradawi): atos homossexuais são haram, ponto. Posição progressista (Scott Kugle, Muslims for Progressive Values): a tradição errou na interpretação — Lut condena violência, não amor consensual. Posição intermediária: a atração não é pecado, mas o ato é — similar à posição católica. Historicamente, o califado islâmico medieval foi mais tolerante que a Europa cristã da época, com poesia homoafetiva aberta e punição raramente aplicada."
  },
    ...
    sources: [
      {
        ...
        text: "Quem matar uma alma — a menos que seja por assassinato ou corrupção na terra — é como se tivesse matado toda a humanidade. E quem salvar uma alma é como se tivesse salvo toda a humanidade.",
        arabic: "مَن قَتَلَ نَفْسًۢا بِغَيْرِ نَفْسٍ أَوْ فَسَادٍ فِى ٱلْأَرْضِ فَكَأَنَّمَا قَتَلَ ٱلنَّاسَ جَمِيعًا",
        context: "Este versículo é a base ética anti-violência do Quran. Terroristas que matam civis violam este princípio corânico central."
      },
      {
        type: "scholarly",
        reference: "Declaração de Marrakesh, 2016",
        text: "Cidadãos muçulmanos e não-muçulmanos são iguais em direitos e dignidade.",
        context: "Assinada por mais de 250 estudiosos de 120 países, afirma direitos plenos de minorias em países muçulmanos e condena terrorismo."
      }
    ],
    quranPosition: "O Quran em 5:32 equipara matar um inocente a matar toda a humanidade. Em 2:190, condiciona combate à defesa e proíbe agressão. Em 60:8, ordena tratamento justo e bondoso com quem não combate os muçulmanos. O terrorismo é uma violação direta de múltiplos princípios corânicos centrais.",
    internalDebate: "O jihadismo moderno é produto de Sayyid Qutb (executado 1966) e Abdullah Azzam (jihad afegão anos 80) — são INOVAÇÕES ideológicas recentes, não tradição clássica. A vasta maioria dos estudiosos (Al-Azhar, Hamza Yusuf, Abdal Hakim Murad) condena terrorismo como heresia. O problema estrutural: sem papa ou hierarquia centralizada no Islam sunita, qualquer pessoa pode se declarar autoridade — isso é vulnerabilidade ao extremismo E força da tradição descentralizada."
  },
    ...
    sources: [
      {
        ...
        text: "Se temeis não ser justos com os órfãos, casai com as mulheres que vos agradem: duas, três ou quatro. Mas se temeis não ser justos, então [casai com] apenas uma.",
        arabic: "فَٱنكِحُوا۟ مَا طَابَ لَكُم مِّنَ ٱلنِّسَآءِ مَثْنَىٰ وَثُلَـٰثَ وَرُبَـٰعَ فَإِنْ خِفْتُمْ أَلَّا تَعْدِلُوا۟ فَوَٰحِدَةً",
        context: "Revelado após a batalha de Uhud, quando havia muitas viúvas e órfãos. A CONDIÇÃO de justiça é central."
      },
      {
        type: "quran",
        reference: "Surah An-Nisa 4:129",
        text: "Não podeis ser plenamente justos entre as esposas, mesmo que o desejeis.",
        arabic: "وَلَن تَسْتَطِيعُوٓا۟ أَن تَعْدِلُوا۟ بَيْنَ ٱلنِّسَآءِ وَلَوْ حَرَصْتُمْ",
        context: "O mesmo Quran que permite a poligamia declara a condição HUMANAMENTE IMPOSSÍVEL de cumprir — o que muitos juristas leem como inviabilização prática."
      }
    ],
    quranPosition: "O Quran PERMITE poligamia com uma condição impossível: justiça absoluta (4:3). E o mesmo Quran declara que 'não podeis ser plenamente justos, mesmo que o desejeis' (4:129). Muitos juristas leem esses versículos juntos como uma inviabilização prática — permissão teórica com barreira prática intencional.",
    internalDebate: "Muhammad Abduh (Egito, séc. XIX) usou 4:3+4:129 para argumentar pela proibição legal da poligamia. A Tunísia seguiu essa lógica e proibiu. A Turquia também proíbe. O Marrocos exige aprovação judicial. Estudiosos conservadores dizem que a permissão permanece válida quando as condições são cumpridas. Na prática, menos de 4% dos casamentos em países muçulmanos são polígamos. O debate é entre permissão textual e aplicação prática."
  },

  {
    ...
    sources: [
      {
        type: "quran",
        reference: "Surah Al-Baqara 2:286",
        text: "Allah não impõe a nenhuma alma além da sua capacidade.",
        arabic: "لَا يُكَلِّفُ ٱللَّهُ نَفْسًا إِلَّا وُسْعَهَا",
        context: "Princípio de que o sofrimento nunca excede a capacidade da alma — consolo para quem tem fé, insuficiente para quem questiona."
      },
      {
        type: "quran",
        reference: "Surah Qaf 50:16",
        text: "Estamos mais perto dele do que sua própria veia jugular.",
        arabic: "وَنَحْنُ أَقْرَبُ إِلَيْهِ مِنْ حَبْلِ ٱلْوَرِيدِ",
        context: "A proximidade de Deus não elimina o sofrimento — mas significa que ninguém sofre sozinho na perspectiva islâmica."
      }
    ],
    quranPosition: "O Quran não nega o sofrimento nem o trivializa. Diz que a vida é prova (67:2 — 'criou a morte e a vida para vos testar'), que nenhuma alma carrega mais do que pode (2:286), que Deus está mais próximo que a veia jugular (50:16), e que TODA injustiça será acertada no Dia do Julgamento (99:7-8). A resposta islâmica é de perspectiva eterna, não de satisfação imediata.",
    internalDebate: "Al-Ghazali escreveu extensivamente sobre teodiceia em 'Ihya Ulum al-Din'. Ibn Qayyim desenvolveu a ideia de que o sofrimento pode ser purificação. Modernos como Abdal Hakim Murad abordam com sofisticação filosófica completa sem negar a dificuldade. Nenhum estudioso sério diz 'aceita e pronto'. Todos reconhecem que a resposta completa exige fé na perspectiva eterna — o que é uma resposta que pede confiança, não prova."
  },
    ...
    sources: [
      {
        ...
        text: "Muhammad não é pai de nenhum de vossos homens, mas sim o Mensageiro de Allah e o Selo dos Profetas.",
        arabic: "مَّا كَانَ مُحَمَّدٌ أَبَآ أَحَدٍ مِّن رِّجَالِكُمْ وَلَـٰكِن رَّسُولَ ٱللَّهِ وَخَاتَمَ ٱلنَّبِيِّـۧنَ",
        context: "'Khatam an-Nabiyyin' — o Selo dos Profetas. A tradição islâmica interpreta isso como encerramento definitivo da profecia."
      }
    ],
    quranPosition: "O Quran é explícito em 33:40: Muhammad é 'Khatam an-Nabiyyin' — o Selo dos Profetas. A revelação está COMPLETA. O Quran é a última palavra de Allah. Isso é artigo de fé, não opinião debatível. Figuras santas (awliya, mujaddidun — renovadores) podem surgir, mas novos profetas com nova revelação, não.",
    internalDebate: "Este é um dos raros pontos de CONSENSO absoluto (ijma') no Islam — não há debate interno significativo. A divergência vem de FORA do Islam ortodoxo: Ahmadiyya (Mirza Ghulam Ahmad) e Bahá'í (Bahá'u'lláh) reivindicam profecia ou manifestação divina pós-Muhammad. O mainstream islâmico os considera religiões separadas, não reformas do Islam. A perseguição dos Ahmadis no Paquistão (proibidos de se autodeclararem muçulmanos) é um caso onde teologia vira violência política — reconhecido como problema por muçulmanos progressistas."
  }
];
